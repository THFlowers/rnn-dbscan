...
public class BasicTest {
    public static void main(final String[] args)  {
        ...
        if (args.length < 1) {
            System.out.println("Arg1 should be text file containing set to cluster");
            System.exit(20);
        }
        if (args.length > 1) {
        ...
        try {
            ...
            System.out.println("Found non-floating point data");
            System.exit(30);
        }
        ...
        SwingUtilities.invokeLater(() -> {
            xyScatterPlot dbplot = new xyScatterPlot(clusters, finalData);
        ...
        SwingUtilities.invokeLater(() -> {
            xyScatterPlot rnnplot = new xyScatterPlot(clusters2, finalData2);
